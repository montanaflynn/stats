...
func main() {
    ...
    r = stats.Sample([]float64{0.1,0.2,0.3,0.4}, 3, false)
    fmt.Println(r) //[0.2,0.4,0.3]

    r = stats.Sample([]float64{0.1,0.2,0.3,0.4}, 10, true)
    fmt.Println(r) //[0.2,0.2,0.4,0.1,0.2,0.4,0.3,0.2,0.2,0.1]
}
```
