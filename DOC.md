...
## <a name="AutoCorrelation">func</a> [AutoCorrelation](/src/target/correlation.go?s=853:918#L38)
``` go
...
## <a name="ChebyshevDistance">func</a> [ChebyshevDistance](/src/target/distances.go?s=368:456#L20)
``` go
...
## <a name="Correlation">func</a> [Correlation](/src/target/correlation.go?s=112:171#L8)
``` go
...
## <a name="Covariance">func</a> [Covariance](/src/target/variance.go?s=1284:1342#L53)
``` go
...
## <a name="CovariancePopulation">func</a> [CovariancePopulation](/src/target/variance.go?s=1864:1932#L81)
``` go
...
## <a name="CumulativeSum">func</a> [CumulativeSum](/src/target/cumulative_sum.go?s=81:137#L4)
``` go
...
## <a name="Entropy">func</a> [Entropy](/src/target/entropy.go?s=77:125#L6)
``` go
...
## <a name="EuclideanDistance">func</a> [EuclideanDistance](/src/target/distances.go?s=836:924#L36)
``` go
...
## <a name="GeometricMean">func</a> [GeometricMean](/src/target/mean.go?s=319:373#L18)
``` go
...
## <a name="HarmonicMean">func</a> [HarmonicMean](/src/target/mean.go?s=717:770#L40)
``` go
...
## <a name="InterQuartileRange">func</a> [InterQuartileRange](/src/target/quartile.go?s=821:880#L45)
``` go
...
## <a name="ManhattanDistance">func</a> [ManhattanDistance](/src/target/distances.go?s=1277:1365#L50)
``` go
...
## <a name="Max">func</a> [Max](/src/target/max.go?s=78:130#L8)
``` go
...
## <a name="Mean">func</a> [Mean](/src/target/mean.go?s=77:122#L6)
``` go
...
## <a name="Median">func</a> [Median](/src/target/median.go?s=85:143#L6)
``` go
...
## <a name="MedianAbsoluteDeviation">func</a> [MedianAbsoluteDeviation](/src/target/deviation.go?s=125:197#L6)
``` go
...
## <a name="MedianAbsoluteDeviationPopulation">func</a> [MedianAbsoluteDeviationPopulation](/src/target/deviation.go?s=360:442#L11)
``` go
...
## <a name="Midhinge">func</a> [Midhinge](/src/target/quartile.go?s=1075:1124#L55)
``` go
...
## <a name="Min">func</a> [Min](/src/target/min.go?s=78:130#L6)
``` go
...
## <a name="MinkowskiDistance">func</a> [MinkowskiDistance](/src/target/distances.go?s=2152:2256#L75)
``` go
...
## <a name="Mode">func</a> [Mode](/src/target/mode.go?s=85:141#L4)
``` go
...
## <a name="Ncr">func</a> [Ncr](/src/target/norm.go?s=7466:7488#L239)
``` go
...
## <a name="NormBoxMullerRvs">func</a> [NormBoxMullerRvs](/src/target/norm.go?s=667:736#L23)
``` go
...
## <a name="NormCdf">func</a> [NormCdf](/src/target/norm.go?s=1858:1917#L52)
``` go
...
## <a name="NormEntropy">func</a> [NormEntropy](/src/target/norm.go?s=5844:5896#L179)
``` go
...
## <a name="NormFit">func</a> [NormFit](/src/target/norm.go?s=6133:6172#L186)
``` go
...
## <a name="NormInterval">func</a> [NormInterval](/src/target/norm.go?s=7062:7135#L221)
``` go
...
## <a name="NormIsf">func</a> [NormIsf](/src/target/norm.go?s=4386:4449#L137)
``` go
...
## <a name="NormLogCdf">func</a> [NormLogCdf](/src/target/norm.go?s=2052:2114#L57)
``` go
...
## <a name="NormLogPdf">func</a> [NormLogPdf](/src/target/norm.go?s=1617:1679#L47)
``` go
...
## <a name="NormLogSf">func</a> [NormLogSf](/src/target/norm.go?s=2471:2532#L67)
``` go
...
## <a name="NormMean">func</a> [NormMean](/src/target/norm.go?s=6646:6695#L206)
``` go
...
## <a name="NormMedian">func</a> [NormMedian](/src/target/norm.go?s=6517:6568#L201)
``` go
...
## <a name="NormMoment">func</a> [NormMoment](/src/target/norm.go?s=4750:4808#L146)
``` go
...
## <a name="NormPdf">func</a> [NormPdf](/src/target/norm.go?s=1379:1438#L42)
``` go
...
## <a name="NormPpf">func</a> [NormPpf](/src/target/norm.go?s=2910:2973#L75)
``` go
...
## <a name="NormPpfRvs">func</a> [NormPpfRvs](/src/target/norm.go?s=247:310#L12)
``` go
...
## <a name="NormSf">func</a> [NormSf](/src/target/norm.go?s=2290:2348#L62)
``` go
...
## <a name="NormStats">func</a> [NormStats](/src/target/norm.go?s=5348:5416#L161)
``` go
...
## <a name="NormStd">func</a> [NormStd](/src/target/norm.go?s=6900:6948#L216)
``` go
...
## <a name="NormVar">func</a> [NormVar](/src/target/norm.go?s=6761:6809#L211)
``` go
...
## <a name="Pearson">func</a> [Pearson](/src/target/correlation.go?s=655:710#L33)
``` go
...
## <a name="Percentile">func</a> [Percentile](/src/target/percentile.go?s=98:181#L8)
``` go
...
## <a name="PercentileNearestRank">func</a> [PercentileNearestRank](/src/target/percentile.go?s=1079:1173#L54)
``` go
...
## <a name="PopulationVariance">func</a> [PopulationVariance](/src/target/variance.go?s=828:896#L31)
``` go
...
## <a name="Round">func</a> [Round](/src/target/round.go?s=88:154#L6)
``` go
...
## <a name="Sample">func</a> [Sample](/src/target/sample.go?s=112:192#L9)
``` go
...
## <a name="SampleVariance">func</a> [SampleVariance](/src/target/variance.go?s=1058:1122#L42)
``` go
...
## <a name="Sigmoid">func</a> [Sigmoid](/src/target/sigmoid.go?s=228:278#L9)
``` go
...
## <a name="SoftMax">func</a> [SoftMax](/src/target/softmax.go?s=206:256#L8)
``` go
...
## <a name="StableSample">func</a> [StableSample](/src/target/sample.go?s=974:1042#L50)
``` go
...
## <a name="StandardDeviation">func</a> [StandardDeviation](/src/target/deviation.go?s=695:762#L27)
``` go
...
## <a name="StandardDeviationPopulation">func</a> [StandardDeviationPopulation](/src/target/deviation.go?s=892:969#L32)
``` go
...
## <a name="StandardDeviationSample">func</a> [StandardDeviationSample](/src/target/deviation.go?s=1254:1327#L46)
``` go
...
## <a name="StdDevP">func</a> [StdDevP](/src/target/legacy.go?s=339:396#L14)
``` go
...
## <a name="StdDevS">func</a> [StdDevS](/src/target/legacy.go?s=497:554#L19)
``` go
...
## <a name="Sum">func</a> [Sum](/src/target/sum.go?s=78:130#L6)
``` go
...
## <a name="Trimean">func</a> [Trimean](/src/target/quartile.go?s=1320:1368#L65)
``` go
...
## <a name="VarP">func</a> [VarP](/src/target/legacy.go?s=59:113#L4)
``` go
...
## <a name="VarS">func</a> [VarS](/src/target/legacy.go?s=193:247#L9)
``` go
...
## <a name="Variance">func</a> [Variance](/src/target/variance.go?s=659:717#L26)
``` go
...
## <a name="Coordinate">type</a> [Coordinate](/src/target/regression.go?s=143:183#L9)
``` go
...
### <a name="ExpReg">func</a> [ExpReg](/src/target/legacy.go?s=791:856#L29)
``` go
...
### <a name="LinReg">func</a> [LinReg](/src/target/legacy.go?s=643:708#L24)
``` go
...
### <a name="LogReg">func</a> [LogReg](/src/target/legacy.go?s=944:1009#L34)
``` go
...
## <a name="Float64Data">type</a> [Float64Data](/src/target/data.go?s=80:106#L4)
``` go
...
### <a name="LoadRawData">func</a> [LoadRawData](/src/target/load.go?s=119:168#L9)
``` go
...
### <a name="Float64Data.AutoCorrelation">func</a> (Float64Data) [AutoCorrelation](/src/target/data.go?s=3257:3320#L91)
``` go
...
### <a name="Float64Data.Correlation">func</a> (Float64Data) [Correlation](/src/target/data.go?s=3058:3122#L86)
``` go
...
### <a name="Float64Data.Covariance">func</a> (Float64Data) [Covariance](/src/target/data.go?s=4801:4864#L141)
``` go
...
### <a name="Float64Data.CovariancePopulation">func</a> (Float64Data) [CovariancePopulation](/src/target/data.go?s=4983:5056#L146)
``` go
...
### <a name="Float64Data.CumulativeSum">func</a> (Float64Data) [CumulativeSum](/src/target/data.go?s=883:938#L28)
``` go
...
### <a name="Float64Data.Entropy">func</a> (Float64Data) [Entropy](/src/target/data.go?s=5480:5527#L162)
``` go
...
### <a name="Float64Data.GeometricMean">func</a> (Float64Data) [GeometricMean](/src/target/data.go?s=1332:1385#L40)
``` go
...
### <a name="Float64Data.Get">func</a> (Float64Data) [Get](/src/target/data.go?s=129:168#L7)
``` go
...
### <a name="Float64Data.HarmonicMean">func</a> (Float64Data) [HarmonicMean](/src/target/data.go?s=1460:1512#L43)
``` go
...
### <a name="Float64Data.InterQuartileRange">func</a> (Float64Data) [InterQuartileRange](/src/target/data.go?s=3755:3813#L106)
``` go
...
### <a name="Float64Data.Len">func</a> (Float64Data) [Len](/src/target/data.go?s=217:247#L10)
``` go
...
### <a name="Float64Data.Less">func</a> (Float64Data) [Less](/src/target/data.go?s=318:358#L13)
``` go
...
### <a name="Float64Data.Max">func</a> (Float64Data) [Max](/src/target/data.go?s=645:688#L22)
``` go
...
### <a name="Float64Data.Mean">func</a> (Float64Data) [Mean](/src/target/data.go?s=1005:1049#L31)
``` go
...
### <a name="Float64Data.Median">func</a> (Float64Data) [Median](/src/target/data.go?s=1111:1157#L34)
``` go
...
### <a name="Float64Data.MedianAbsoluteDeviation">func</a> (Float64Data) [MedianAbsoluteDeviation](/src/target/data.go?s=1630:1693#L46)
``` go
...
### <a name="Float64Data.MedianAbsoluteDeviationPopulation">func</a> (Float64Data) [MedianAbsoluteDeviationPopulation](/src/target/data.go?s=1842:1915#L51)
``` go
...
### <a name="Float64Data.Midhinge">func</a> (Float64Data) [Midhinge](/src/target/data.go?s=3912:3973#L111)
``` go
...
### <a name="Float64Data.Min">func</a> (Float64Data) [Min](/src/target/data.go?s=536:579#L19)
``` go
...
### <a name="Float64Data.Mode">func</a> (Float64Data) [Mode](/src/target/data.go?s=1217:1263#L37)
``` go
...
### <a name="Float64Data.Pearson">func</a> (Float64Data) [Pearson](/src/target/data.go?s=3455:3515#L96)
``` go
...
### <a name="Float64Data.Percentile">func</a> (Float64Data) [Percentile](/src/target/data.go?s=2696:2755#L76)
``` go
...
### <a name="Float64Data.PercentileNearestRank">func</a> (Float64Data) [PercentileNearestRank](/src/target/data.go?s=2869:2939#L81)
``` go
...
### <a name="Float64Data.PopulationVariance">func</a> (Float64Data) [PopulationVariance](/src/target/data.go?s=4495:4553#L131)
``` go
...
### <a name="Float64Data.Quartile">func</a> (Float64Data) [Quartile](/src/target/data.go?s=3610:3673#L101)
``` go
...
### <a name="Float64Data.QuartileOutliers">func</a> (Float64Data) [QuartileOutliers](/src/target/data.go?s=2542:2599#L71)
``` go
...
### <a name="Float64Data.Sample">func</a> (Float64Data) [Sample](/src/target/data.go?s=4208:4269#L121)
``` go
...
### <a name="Float64Data.SampleVariance">func</a> (Float64Data) [SampleVariance](/src/target/data.go?s=4652:4706#L136)
``` go
...
### <a name="Float64Data.Sigmoid">func</a> (Float64Data) [Sigmoid](/src/target/data.go?s=5169:5218#L151)
``` go
...
### <a name="Float64Data.SoftMax">func</a> (Float64Data) [SoftMax](/src/target/data.go?s=5359:5408#L157)
``` go
...
### <a name="Float64Data.StandardDeviation">func</a> (Float64Data) [StandardDeviation](/src/target/data.go?s=2026:2083#L56)
``` go
...
### <a name="Float64Data.StandardDeviationPopulation">func</a> (Float64Data) [StandardDeviationPopulation](/src/target/data.go?s=2199:2266#L61)
``` go
...
### <a name="Float64Data.StandardDeviationSample">func</a> (Float64Data) [StandardDeviationSample](/src/target/data.go?s=2382:2445#L66)
``` go
...
### <a name="Float64Data.Sum">func</a> (Float64Data) [Sum](/src/target/data.go?s=764:807#L25)
``` go
...
### <a name="Float64Data.Swap">func</a> (Float64Data) [Swap](/src/target/data.go?s=425:460#L16)
``` go
...
### <a name="Float64Data.Trimean">func</a> (Float64Data) [Trimean](/src/target/data.go?s=4059:4119#L116)
``` go
...
### <a name="Float64Data.Variance">func</a> (Float64Data) [Variance](/src/target/data.go?s=4350:4398#L126)
``` go
...
## <a name="Outliers">type</a> [Outliers](/src/target/outlier.go?s=73:139#L4)
``` go
...
### <a name="QuartileOutliers">func</a> [QuartileOutliers](/src/target/outlier.go?s=197:255#L10)
``` go
...
## <a name="Quartiles">type</a> [Quartiles](/src/target/quartile.go?s=75:136#L6)
``` go
...
### <a name="Quartile">func</a> [Quartile](/src/target/quartile.go?s=205:256#L13)
``` go
...
## <a name="Series">type</a> [Series](/src/target/regression.go?s=76:100#L6)
``` go
...
### <a name="ExponentialRegression">func</a> [ExponentialRegression](/src/target/regression.go?s=1089:1157#L50)
``` go
...
### <a name="LinearRegression">func</a> [LinearRegression](/src/target/regression.go?s=262:325#L14)
``` go
...
### <a name="LogarithmicRegression">func</a> [LogarithmicRegression](/src/target/regression.go?s=1903:1971#L85)
``` go
